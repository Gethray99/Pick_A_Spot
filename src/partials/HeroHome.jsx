...
import HeroImage from '../images/PickASpot LOGO.png';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h3 className="h1 mb-4" data-aos="fade-up">
              Pick A Spot 
            </h3>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              Let us find you a good parking spot for you
            </p>
          ...
          <div>
            <div className="relative flex justify-center items-center" data-aos="fade-up" data-aos-delay="200">
              <img className="mx-auto" src={HeroImage} width="80%" height="50%" alt="Hero" /> {/*width="1024" height="504" alt="Hero"*/}
              <a
            ...
            <Modal id="modal" ariaLabel="modal-headline" show={videoModalOpen} handleClose={() => setVideoModalOpen(false)}>
              ...
              <video ref={video} className="absolute w-full h-full" width="1920" height="1080" autoPlay>
