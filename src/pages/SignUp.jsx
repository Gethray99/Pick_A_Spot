          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <h2 className="h1">Hold hands with us and let us make your life more easy</h2>
              </div>
              ...
              <div className="max-w-sm mx-auto">
                ...
                <div className="flex flex-wrap -mx-3 mt-6">
                    <div className="w-full px-3">
                      <button className="btn text-white bg-purple-600 hover:bg-purple-700 w-full" ><Link to="/index2">If you are a provider please click here.</Link></button>
                    </div>
                  </div>
                <br />
                <form>
                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      ...
                      <input id="company-name" type="text" className="form-input w-full text-gray-300" placeholder="Phone number" required />
                    </div>
                  </div>
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      ...
                      <input id="email" type="email" className="form-input w-full text-gray-300" placeholder="your@gmail.com" required onChange={(event) => {
